...
model_path = "music_module/facialemotionmodel.h5"
    ...
    with st.container():
        ...
        with col4:
            ...
            if "detected_emotion" in st.session_state:
                selected_emotion = st.session_state.detected_emotion
                st.success(f"Using detected emotion: {selected_emotion}")
            else:
                selected_emotion = st.selectbox(
                    "Choose emotion manually",
